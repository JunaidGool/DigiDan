  ...
  return (
    <section className="scroll-mt-20 py-16 md:py-20">
      <div className="shell flex flex-col items-center text-center">
        ...
        <p className="mt-4 w-full max-w-prose text-base text-ink/80 md:text-lg">
          {credibility.names.join(" · ")}
        </p>
        <p className="mt-10 w-full max-w-3xl font-display text-2xl font-semibold italic leading-[1.25] text-ink md:text-[2rem]">
